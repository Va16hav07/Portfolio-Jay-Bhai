        ...
        <div className="glass-card rounded-2xl p-8 space-y-8">
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-4 gradient-border p-4 rounded-xl group hover:scale-105 transition-transform duration-300">
              <GraduationCap className="w-8 h-8 text-purple-400 group-hover:rotate-12 transition-transform" />
              <div>
                <h4 className="font-medium">Education</h4>
                <p className="text-gray-300">B.Tech in CSE with AI/ML</p>
                <p className="text-gray-400">Polaris School of Technology</p>
                <p className="text-gray-400 text-sm">2024-2028 (Currently Pursuing)</p>
              </div>
            </div>
