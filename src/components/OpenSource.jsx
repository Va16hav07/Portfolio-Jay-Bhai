...
import { GitPullRequest, Star, Github, Code2 } from 'lucide-react';
...
const OpenSource = () => {
  return (
    <section className="py-8" id="opensource">
      <h2 className="text-4xl font-bold mb-12 text-center elegant-text">
        Open Source Journey
      </h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
        <div className="space-y-8">
          <div className="flex items-center gap-6 mb-8">
            <Github className="w-16 h-16 text-primary animate-pulse" />
            <div>
              <h3 className="text-2xl font-bold text-secondary mb-2">Active Contributor</h3>
              <p className="text-text-secondary">Passionate about giving back to the community</p>
            </div>
          </div>
          
          <div className="grid grid-cols-2 gap-4 mb-8">
            <div className="glass-panel rounded-lg p-4 text-center">
              <GitPullRequest className="w-8 h-8 text-primary mx-auto mb-2" />
            ...
            <div className="glass-panel rounded-lg p-4 text-center">
              ...
              <div className="text-2xl font-bold text-secondary">242+</div>
          ...
          {contributions.map((item, index) => (
            ...
            >
              <div className="flex items-center gap-4 mb-4">
                <div className="w-12 h-12 rounded-lg bg-gradient-to-br from-primary to-secondary p-2">
                  <item.icon className="w-full h-full text-white" />
                </div>
                <div>
                  <h4 className="text-lg font-semibold text-primary">{item.title}</h4>
                  <p className="text-sm text-secondary">{item.stats}</p>
                </div>
              </div>
